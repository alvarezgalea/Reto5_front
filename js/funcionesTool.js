...
function getTool(){
    $.ajax({
        url:"http://130.61.126.147:8080/api/Tool/all",
        type:"GET",
        datatype:"JSON",
...
function postTool(){
    ...
    $.ajax({
        url:"http://130.61.126.147:8080/api/Tool/save",
        type:"POST",
        datatype:"JSON",
...
function putTool(idBotonActualizar){
    ...
    $.ajax({
        url:"http://130.61.126.147:8080/api/Tool/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteTool( idBotonBorrar){
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url:"http://130.61.126.147:8080/api/Tool/"+ idBotonBorrar,
                type:"DELETE",
                datatype:"JSON",
...
function getTool_Category(){
    ...
    $.ajax({
        url:"http://130.61.126.147:8080/api/Category/all",
        type:"GET",
        datatype:"JSON",
        success:function(respuesta){
