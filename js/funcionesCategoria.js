...
function postCategoria(){
    if ($("#name").val().length==0 || $("#description").val().length==0 ){
        ...
        $.ajax({
            url:"http://130.61.126.147:8080/api/Category/save",
            type:"POST",
            datatype:"JSON",
...
function putCategoria(idBotonActualizar){
    ...
    $.ajax({
        url:"http://130.61.126.147:80800/api/Category/update",
        type:"PUT",
        datatype:"JSON",
...
function deleteCategoria(idBotonBorrar){
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                url:"http://130.61.126.147:8080/api/Category/"+ idBotonBorrar,
                type:"DELETE",
                datatype:"JSON",
